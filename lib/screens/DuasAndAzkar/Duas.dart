...
class _DuasPageState extends State<DuasPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: customAppbar(context, false, "Dua & Azkar", true),
        body: FutureBuilder(
                                  ...
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => Duas(
                                                ...
                                                content: snapshot.data![i]
                                                    .children[index].children,
                                              ))),
                                  title: Text(
                                      snapshot.data![i].children[index].title),
                                )),
                        leading: Icon(
                          image[i],
                          size: 100.sp,
                                  ...
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => Duas(
                                                title:
                                                    snapshot.data![i - 1].title,
                                                subtitle: snapshot.data![i - 1]
                                                    .children[index].title,
                                                content: snapshot.data![i - 1]
                                                    .children[index].children,
                                              ))),
                                  title: Text(snapshot
                                      .data![i - 1].children[index].title),
                                )),
                        leading: Icon(
                          image[i - 1],
                          size: 100.sp,
